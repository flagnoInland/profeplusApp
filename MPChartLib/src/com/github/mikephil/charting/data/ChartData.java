...
public abstract class ChartData<T extends DataSet<? extends Entry>> {
    ...
    protected List<String> mXAltVals;
    ...
    public ChartData() {
        ...
        mXAltVals = new ArrayList<String>();
    ...
    public ChartData(List<String> xVals, List<String> xAltVals, List<T> sets) {
        this.mXVals = xVals;
        this.mXAltVals = xAltVals;
        this.mDataSets = sets;
    ...
    public List<String> getXAltVals() {
        return mXAltVals;
    }
