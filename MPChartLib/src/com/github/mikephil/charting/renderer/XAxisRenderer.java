...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void computeAxis(float xValAverageLength, List<String> xValues, List<String> xAltValues) {
        ...
        mXAxis.setAltValues(xAltValues);
    }
    ...
    protected void drawLabels(Canvas c, float pos, PointF anchor) {
        ...
        for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisLabelModulus) {
            ...
            if (mViewPortHandler.isInBoundsX(position[0])) {
                ...
                String altLabel = mXAxis.getAltValues().get(i);
                ...
                drawLabel(c, altLabel, i, position[0], pos, anchor,
                        labelRotationAngleDegrees, Color.BLACK, mXAxis.getTextSize());
                //drawLabel(c, altLabel, i, position[0], pos, anchor, labelRotationAngleDegrees);
            }
        }
    }

    protected void drawLabel(Canvas c, String label, int xIndex, float x, float y, PointF anchor,
                             float angleDegrees, int color, float fontSize) {
        String formattedLabel = mXAxis.getValueFormatter().getXValue(label, xIndex, mViewPortHandler);
        Utils.drawText(c, formattedLabel, x, y, mAxisLabelPaint, anchor,
                angleDegrees, color, fontSize);
    }
