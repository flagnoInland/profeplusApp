    ...
    protected void drawLabels(Canvas c, float pos, PointF anchor) {
        ...
        for (int i = mMinX; i <= mMaxX; i += mXAxis.mAxisLabelModulus) {
            ...
            if (mViewPortHandler.isInBoundsX(position[0]) && i >= 0
                ...
                drawLabel(c, label, i, position[0], pos, anchor,
                        labelRotationAngleDegrees, Color.BLACK, mXAxis.getTextSize());
                drawLabel(c, altLabel, i, position[0], pos + 1.5f*mXAxis.getTextSize(),
                        anchor, labelRotationAngleDegrees, Color.BLUE, 1.3f*mXAxis.getTextSize());
            }
        }
    }
