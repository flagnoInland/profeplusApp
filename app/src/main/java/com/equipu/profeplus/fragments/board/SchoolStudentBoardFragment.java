...
/*
Este fragmento se usa para presentar a los estudiantes de educación básica
un pantalla con las opciones:
ENTRAR A CLASE
CAMBIAR MODO
VER MANUAL DE USUARIO
 */
public class SchoolStudentBoardFragment extends Fragment
    ...
    public SchoolStudentBoardFragment() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_school_student_board, container, false);
        ...
        // En caso de falla mostrar un mensjae
    ...
    public void enterToExam(){
        String mUrl = String.format( "%s/web/exam/student/%s/2",
    ...
    public void onResume() {
        ...
        // Registrar acción firebase
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "21");
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "PANEL::Estudiante~Básica");
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "PANEL::Estudiante~Básica");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);
        // Filtrar acción para acquisicion de pregunta
        IntentFilter filter = new IntentFilter(NetworkBoardService.ACTION_REGISTER_SESSION);
        registerSessionReceiver = new RegisterSessionReceiver();
        LocalBroadcastManager lbm = LocalBroadcastManager.getInstance(getContext());
        lbm.registerReceiver(registerSessionReceiver, filter);
    }
