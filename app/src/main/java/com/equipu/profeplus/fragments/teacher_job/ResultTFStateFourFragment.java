...
/*
Este fragmento muestra los resultados finales del paso 2 para preguntas de verdadero y falso
btnRefresh esta deshabilitado
Se muestra las opciones
ENVIAR REPORTE
SALIR
 */
public class ResultTFStateFourFragment extends Fragment {
    ...
    public ResultTFStateFourFragment() {}


    public static ResultTFStateFourFragment newInstance(SessionParcel sp, AppStateParcel asp, AnswerList oldList, AnswerList newList) {
    ...
    /*
    Adquirir resultados del paso 2 y mostrar gráfico
     */
