 ...
 * Diálogo simple de notificación que no pasa parámetros.
 */
public class NotificationOneButtonSupportDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        msgDialog.setText(Html.fromHtml(message));
        msgDialog.setMovementMethod(LinkMovementMethod.getInstance());
